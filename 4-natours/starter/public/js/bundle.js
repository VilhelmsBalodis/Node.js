  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51NkjApF3XNMYXkFb39dw2y1uCrQormrlAtlonFwL0Ickt3UgcJBStNZMxk0tuJTU1TsKXUWBfkpeceIQTgsTLp0M00plmXdwBQ'); // 1. get checkout session from API
          _context.next = 4;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmlsaGVsbXMtYmFsb2RpcyIsImEiOiJjbGsyYnFuanEwN3NqM2twa3FyYWpiM3dwIn0.aj4s-Ez-p8ss1rre3fV5Eg';
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3541" + '/');
